...
class IotaAccountIntegrationTest {
    ...
    private static final int MWM = 9;
    ...
    void sendZeroValueTest() throws AccountError, InterruptedException, ExecutionException {
        ...
        JsonFlatFileStore json = new JsonFlatFileStore(this.getClass().getResourceAsStream("/accounts/client-test.store"), NULL_OUTPUT_STREAM);
    ...
    void sendLongMultiValueTest() throws AccountError, InterruptedException, ExecutionException {
        ...
        JsonFlatFileStore json = new JsonFlatFileStore(this.getClass().getResourceAsStream("/accounts/client-testMulti.store"), NULL_OUTPUT_STREAM);
        store = new AccountFileStore(json);
