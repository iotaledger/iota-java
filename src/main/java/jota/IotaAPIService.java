...
public interface IotaAPIService {
    ...
    String VERSION_HEADER = "X-IOTA-API-Version: 1.4.1";

    /**
     * Returns information about your node.
     * <p>
     * curl http://localhost:14265 -X POST -H 'Content-Type: application/json' -H 'X-IOTA-API-Version: 1.4.1'
     * -d '{"command": "getNodeInfo"}'
     *
     * @return a {@code NodeInfoResponse} object, if succesfull.
     */
    @Headers({CONTENT_TYPE_HEADER, USER_AGENT_HEADER, VERSION_HEADER})
    @POST("./")
